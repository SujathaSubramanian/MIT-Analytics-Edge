...
# Redo the plot, removing any states with murder rates above 10:(i.e outliers)
ggplot(murderMap, aes(x = long, y = lat, group = group, fill = MurderRate)) + geom_polygon(color = "black") + scale_fill_gradient(low = "black", high = "red", guide = "legend", limits = c(0,10))

murderMap$GunOwnershipRate = murderMap$GunOwnership / murderMap$Population * 100000
summary(murderMap)
ggplot(murderMap, aes(x = long, y = lat, group = group, fill = GunOwnershipRate)) + geom_polygon(color = "black") + scale_fill_gradient(low = "black", high = "red", guide = "legend", limits = c(0,.1))
