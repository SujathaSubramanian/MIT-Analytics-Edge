...
x = subset(ClaimsTrain,diabetes ==1)
...
PenaltyMatrix = c(0,2,4,6,8)

table(ClaimsTest$bucket2009) * PenaltyMatrix

totalerror = sum(table(ClaimsTest$bucket2009) * PenaltyMatrix)/nrow(ClaimsTest)
# VIDEO 8
